...
public class AddCeCAvailableWithAddressStoreWithStockTest extends Hooks {
    public AddCeCAvailableWithAddressStoreWithStockTest() throws IOException{
        super();
    }
    ...
    public void AddCeCItem() throws IOException {
        ...
        product.getStoreSearch().sendKeys("Auckland, New Zealand");
