...
public class AddSDDAvailableWithAddressTest extends Hooks {
    public AddSDDAvailableWithAddressTest() throws IOException{
        super();
    }
    ...
    public void AddSDDItem() throws IOException {
        ...
        product.getDeliverySearch().sendKeys("William Bond");
        ...
        for(WebElement address:addresses) {
            if(address.getText().contains("2 William")) {
                address.click();
                break;
            }
